      ...
      <>
         <div className="md:flex sm:grid gap-4 justify-between ">
            ...
            <div>
               ...
               <h1>Story Draw</h1>
               <Link href={`/storyboard/1/5`} className="p-6">
                  Voltar
               </Link>
...
const UploadMidias = ({ story, shot, midias }) => {
   ...
   const saveImageURL = async (url, comment = "") => {
      ...
      const finalFile = new File(
         ...
         new Date().toISOString() + "_canva_draw.png",
         {
            type: "image/png",
         }
      );
   ...
   return (
      <>
         {uploadingmidia > 0 ? (
            "enviando... " + uploadingmidia
         ) : (
            <div className=" grid gap-4 justify-between mb-4 md:flex">
               {showDraw ? null : (
                  <div>
               ...
               <div>
                  {showDraw ? (
                     <DrawComponent saveImageURL={saveImageURL} />
                  ) : (
                     <>
                        <div className="gap-4 flex">
                           <Button onClick={() => setShowDraw((prev) => !prev)}>
                              {"Desenhar"}
                           </Button>
                        </div>
                     </>
